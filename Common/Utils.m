...
+ (NSString *)getLoginToken{
    return [[NSUserDefaults standardUserDefaults]stringForKey:FAF_SERVER_USER_TOKEN];
}

+ (void)setLoginToken:(NSString *)token{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setValue:[Utils isNilOrNSNull:token] ? @"":token forKey:FAF_SERVER_USER_TOKEN];
